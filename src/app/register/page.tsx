        ...
        <section className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-stretch">
          ...
          <div className={`rounded-[2rem] p-8 ${config.panel}`}>
            ...
            <form className="mt-6 grid gap-4" onSubmit={onSubmit}>
              ...
              <button type="submit" disabled={isLoading} className={`inline-flex h-12 items-center justify-center rounded-full px-6 text-sm font-semibold disabled:opacity-60 ${config.action}`}>
